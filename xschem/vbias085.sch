...
T {0.5/1 => 2/0.35 (0.5 vs 5.71; 11.42x)
0.5/2 => 2/0.7
0.5/4 => 2/1.4
0.5/4 => 2/1.4
2.5/1 => 7.5/0.5 (2.5 vs 15; 6x)} 400 -520 0 0 0.3 0.3 {}
T {0.5/1 => 0.5/0.5 (0.5 vs 1.0; 2x)
0.5/2 => 0.5/1
0.5/4 => 0.5/2
0.5/4 => 0.5/2
2.5/1 => 1.75/0.5 (1.4x)} 400 -390 0 0 0.3 0.3 {}
T {0.5/1 => 0.65/0.5 (0.5 vs 1.0; 2.6x)
0.5/2 => 0.65/1
0.5/4 => 0.65/2
0.5/4 => 0.65/2
2.5/1 => 2.1/0.5 (1.68x)} 400 -260 0 0 0.3 0.3 {}
T {0.5/1 => 0.85/0.5 (0.5 vs 1.0; 3.4x)
0.5/2 => 0.85/1
0.5/4 => 0.85/2
0.5/4 => 0.85/2
2.5/1 => 2.6/0.5 (2.07x)} 660 -260 0 0 0.3 0.3 {}
N 130 -170 130 -140 {
lab=Vbias}
N 310 -470 310 -440 {
lab=Vbias}
...
C {iopin.sym} 490 -610 0 1 {name=p1 lab=VPWR}
C {iopin.sym} 490 -590 0 1 {name=p5 lab=VGND}
