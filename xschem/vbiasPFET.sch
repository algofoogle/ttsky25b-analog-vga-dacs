...
N 130 0 130 10 {lab=VGND}
N 130 -80 130 -60 {lab=#net2}
N 130 -60 170 -60 {lab=#net2}
N 170 -60 170 -30 {lab=#net2}
N 310 -110 460 -110 {lab=#net1}
N 500 -80 500 -60 {lab=Vbias}
N 460 -60 460 -30 {lab=Vbias}
N 460 -60 500 -60 {lab=Vbias}
N 500 0 500 10 {lab=VGND}
...
C {sky130_fd_pr/nfet3_g5v0d10v5.sym} 150 -30 0 1 {name=M6
W=2.5
L=1
body=VGND
nf=1
...
C {sky130_fd_pr/nfet3_g5v0d10v5.sym} 480 -30 0 0 {name=M5
W=2.5
L=1
body=VGND
nf=1
...
C {sky130_fd_pr/nfet3_g5v0d10v5.sym} 480 -110 0 0 {name=Mmirror1
W=2.5
L=1
body=VGND
nf=1
