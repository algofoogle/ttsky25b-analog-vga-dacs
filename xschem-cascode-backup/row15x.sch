...
C {vbiasS5.sym} 250 -560 0 0 {name=x1}
C {opin.sym} 100 -460 0 0 {name=p32 lab=Vbias}
C {lab_pin.sym} 350 -540 0 1 {name=p10 sig_type=std_logic lab=Vbias}
C {ipin.sym} 100 -260 0 0 {name=p35 lab=VbiasH}
C {ipin.sym} 100 -240 0 0 {name=p36 lab=VbiasL}
C {lab_pin.sym} 350 -580 0 1 {name=p33 sig_type=std_logic lab=VPWR}
C {lab_pin.sym} 350 -560 0 1 {name=p34 sig_type=std_logic lab=VGND}
C {lab_pin.sym} 150 -580 0 0 {name=p37 sig_type=std_logic lab=VbiasH}
C {lab_pin.sym} 150 -560 0 0 {name=p38 sig_type=std_logic lab=VbiasL}
